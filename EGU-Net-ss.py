...
def my_network_optimization(y_est, y_re, r1, r2, l2_loss, reg, learning_rate, global_step):
    ...
    with tf.name_scope("cost"):
        ...
        cost = tf.reduce_mean(tf.nn.softmax_cross_entropy_with_logits(logits=r1, labels=r3))
...
def train_my_network(x_pure_set, x_mixed_set, x_mixed_set1, y_train, y_test, learning_rate_base=0.3, beta_reg=0.005,
