...
def random_mini_batches_ccc(X1, X2, X1_FULL, X2_FULL, X1_UN, X2_UN, Y_P, Y, mini_batch_size, seed):
    ...
    for k in range(0, num_complete_minibatches):
        ...
        mini_batch_Y = shuffled_Y[k * mini_batch_size: k * mini_batch_size + mini_batch_size, :]
        mini_batch = (
            mini_batch_X1, mini_batch_X2, mini_batch_X1_FULL, mini_batch_X2_FULL, mini_batch_X1_UN, mini_batch_X2_UN,
            mini_batch_X1_UN_FULL, mini_batch_Y)
        mini_batches.append(mini_batch)
...
def random_mini_batches_un(X1, X2, X1_UN, X1_FULL, X2_FULL, Y, mini_batch_size, seed):
    ...
    for k in range(0, num_complete_minibatches):
        ...
        mini_batch_Y = shuffled_Y[k * mini_batch_size: k * mini_batch_size + mini_batch_size, :]
        mini_batch = (
            mini_batch_X1, mini_batch_X2, mini_batch_X1_UN, mini_batch_X1_FULL, mini_batch_X2_FULL, mini_batch_Y)
        mini_batches.append(mini_batch)
